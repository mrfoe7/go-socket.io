...
var tests = []struct {
	...
	{true, []byte{0x01, 0x01, 0x03, 0xff, 0x04, 'h', 'e', 'l', 'l', 'o', ' ', 0xe4, 0xbd, 0xa0, 0xe5, 0xa5, 0xbd},
		[]Packet{
	...
	{false, []byte("13:4hello 你好"),
		[]Packet{
			{frame.String, packet.MESSAGE, []byte("hello 你好")},
		},
	},
	{false, []byte("18:b4aGVsbG8g5L2g5aW9"),
		[]Packet{
			{frame.Binary, packet.MESSAGE, []byte("hello 你好")},
		},
	},
